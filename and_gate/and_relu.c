...
int main() {
	...
	float out0 = relu(w1 * train[0][0] + w2 * train[0][1] + b);
    float out1 = relu(w1 * train[1][0] + w2 * train[1][1] + b);
    float out2 = relu(w1 * train[2][0] + w2 * train[2][1] + b);
    float out3 = relu(w1 * train[3][0] + w2 * train[3][1] + b);
